...
2.3) Navigate back to your Gitlab project and press the blue `clone` button, then copy the `Clone with SSH` option ![image](https://user-images.githubusercontent.com/31989404/110539127-25083500-8125-11eb-9c99-ed2dc693f70b.png)

2.4) Back in IntelliJ, paste it under the `URL` box and pick a location where you want to save the project

2.5) When asked if you want to connect anyways, pick yes
